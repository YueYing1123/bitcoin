...
def test_native_instance_record() -> None:
    record = {
        ...
        "instance_fields": {
            ...
            "direct_related_contract_validity_first_instance": {"value": "不受法律保护", "evidence": None},
            "direct_related_contract_validity_second_instance": {"value": "不适用", "evidence": None},
    ...
    assert_equal(get_field_value(record, field_map["direct_related_contract_validity_first_instance"]), "", "invalid direct validity cleared")
    assert_equal(get_field_value(record, field_map["direct_related_contract_validity_second_instance"]), "", "not applicable validity cleared")
