...
`direct_transaction_legality_assessment_*` 和 `indirect_transaction_legality_assessment_*` 只能从以下范围选择：合法有效、合同无效、不受法律保护、非法金融活动、违反监管政策、违背公序良俗、涉嫌犯罪、风险自担、未明确、不适用。

直接交易合法性针对虚拟货币买卖、兑换、OTC、委托投资/代投、发币/ICO、虚拟货币借贷、交易所充值提币等紧密涉币安排。间接交易合法性针对挖矿供用电合同、矿机或算力买卖/租赁、矿机托管、场地租赁、技术服务、劳动/承揽等以虚拟货币或挖矿为背景但标的本身不是虚拟货币交易的安排。

`direct_related_contract_validity_*` 和 `indirect_related_contract_validity_*` 只能从以下范围选择：有效、无效、未成立、部分有效、部分无效、不受法律保护、不适用、未明确。
...
`judicial_framing_*` 只能从以下范围多选：风险自担、非法债务、不受法律保护、合同无效、返还本金、折价赔偿、财产属性保护、证据不足、刑民交叉、移送公安、涉嫌犯罪、扰乱金融秩序、扰乱货币秩序、违背公序良俗、违反强制性规定、监管政策影响私法效力、请求权基础不成立、其他。
...
`reasoning_changed.value`：一审与二审裁判理由、法律定性、合同效力、交易合法性、司法框架等存在实质差异时填 `true`；否则填 `false`；无法判断填 `null`。当前文书最终只有一审、没有二审或再审处理时，必须填 `null`。
...

{
  ...
  "instance_fields": {
    ...
    "direct_transaction_legality_assessment_first_instance": {"value": null, "evidence": null},
    "direct_transaction_legality_assessment_second_instance": {"value": null, "evidence": null},
    "indirect_transaction_legality_assessment_first_instance": {"value": null, "evidence": null},
    "indirect_transaction_legality_assessment_second_instance": {"value": null, "evidence": null},
...
<few_shot_output>
{
  ...
  "instance_fields": {
    ...
    "direct_transaction_legality_assessment_first_instance": {
      "value": "非法金融活动",
      "evidence": null
    },
    "direct_transaction_legality_assessment_second_instance": {
      "value": null,
      "evidence": null
    },
    "indirect_transaction_legality_assessment_first_instance": {
      "value": "不适用",
      "evidence": null
    },
    "indirect_transaction_legality_assessment_second_instance": {
      "value": null,
      "evidence": null
    },
