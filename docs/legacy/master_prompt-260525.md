...
The following examples use the latest saved manual annotations for the specified cases. Metadata fields remain empty because code fills current-document metadata from data-index.json.

## Few-shot 1: d617820d-839a-4921-8777-b144016abce1
...
<few_shot_output>
{
  ...
  "instance_fields": {
    ...
    "reasoning_summary_first_instance": {
      "value": "宋英华学习虚拟货币投资技术的行为违背公序良俗，不属于法律保护的内容。",
      "evidence": null
    },
    "reasoning_summary_second_instance": {
      "value": "宋英华学习虚拟货币投资技术的行为违背公序良俗，债务不受法律保护，一审处理并无不当。",
      "evidence": null
    },
...
## Few-shot 2: 8a7833d5-1292-4df5-942e-aecd0023287f
...
<few_shot_output>
{
  ...
  "instance_fields": {
    ...
    "case_amount_second_instance": "1495000",
    "case_amount_type_first_instance": "购买价款",
    "case_amount_type_second_instance": "购买价款",
    "case_amount_evidence_first_instance": "合同签订后,原告陆续向被告支付首批次200台矿机的购买费用149.5万元以及预付的电费",
    "case_amount_evidence_second_instance": "合同签订后,原告陆续向被告支付首批次200台矿机的购买费用149.5万元以及预付的电费",
    "case_type_primary_first_instance": {
      "value": "民事",
      "evidence": null
    },
    ...
    "reasoning_summary_first_instance": {
      "value": "委托托管矿机部分因挖矿活动违背公序良俗无效，但矿机本身具有财产属性，委托购销部分有效，双方同意返还矿机，予以支持",
      "evidence": null
    },
    "reasoning_summary_second_instance": {
      "value": "上诉人未能提供有效证据证明上诉理由成立，原审判决认定事实清楚，适用法律正确",
      "evidence": null
    },
    "low_confidence_fields_first_instance": {
      "value": [],
